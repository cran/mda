/* NOTE: this files is only used for R versions PRIOR to R 1.5.0,
 * since from 1.5.0 on,  F77_CALL(interv) is part of the API
 */
#include <Rversion.h>

#if defined(R_VERSION) && R_VERSION < R_Version(1, 5, 0)
/*
